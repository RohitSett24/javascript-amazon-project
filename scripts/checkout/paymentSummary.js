...
export function renderPaymentSummary() {
  ...
  const paymentSummaryHTML = `
    ...
    <div class="payment-summary-row">
      ...
      <div class="payment-summary-money js-shipping-cost">$${convertMoney(shippingCostCents)}</div>
    </div>
    ...
    <div class="payment-summary-row total-row">
      <div>Order total:</div>
      <div class="payment-summary-money js-total-cost">$${convertMoney(totalCostCents)}</div>
    </div>
